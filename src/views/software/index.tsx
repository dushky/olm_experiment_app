...
import { DataGrid, GridColumns,GridCellEditCommitParams } from "@mui/x-data-grid"
import { gridSpacing } from 'assets/constants'
import MainCard from 'ui-components/cards/MainCard'
import { SoftwareDataFragment, useUpdateSoftwareMutation, useCreateSoftwareMutation, useRemoveSoftwareMutation}  from "generated/graphql"
...
const Software = ({software}: Props) => {
    ...
    const handleSubmit = async (value: string) => {
        await createSoftware({
            ...
            setRows([...rows, {id: value.data!.createSoftware.id, name: value.data!.createSoftware.name}])
        })
    }
                ...
                <Button
                    ...
                    onClick={async () => {
                        await removeSoftware({
                            ...
                            setRows(rows.filter((item) => item.id != removedSoftware.data?.removeSoftware.id))
                        })
                    }}
                >
                    Delete
